...
ActiveRecord::Schema[8.0].define(version: 2026_03_02_092015) do
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["share_id"], name: "index_reports_on_share_id"
  ...
  create_table "shares", force: :cascade do |t|
    ...
    t.index ["visibility"], name: "index_shares_on_visibility"
  end
  ...
  add_foreign_key "reports", "shares"
